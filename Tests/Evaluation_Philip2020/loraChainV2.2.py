...
no_of_repeaters = 8
total_no_of_tags = 16
# tags_on_repeaters = [16, 0, 0, 0, 0, 0, 0, 0]
# tags_on_repeaters = [ 8, 8, 0, 0, 0, 0, 0, 0]
# tags_on_repeaters = [ 4, 4, 4, 4, 0, 0, 0, 0]
tags_on_repeaters = [ 2, 2, 2, 2, 2, 2, 2, 2]
# tags_on_repeaters = [ 0, 0, 0, 0, 4, 4, 4, 4]
# tags_on_repeaters = [ 0, 0, 0, 0, 0, 0, 8, 8]
# tags_on_repeaters = [ 0, 0, 0, 0, 0, 0, 0,16]
...
for i in range(no_of_repeaters):
    ...
    for j in range(tags_on_repeaters[i]):
...
totalSimPackets = no_of_repeaters * total_no_of_tags *sim_time
env.run()
